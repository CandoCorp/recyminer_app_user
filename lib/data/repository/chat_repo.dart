...
class ChatRepo {
  ...
  Future<http.StreamedResponse> sendMessage(
      String message, PickedFile file, String token) async {
    http.MultipartRequest request = http.MultipartRequest('POST',
        Uri.parse('${AppConstants.BASE_URL}${AppConstants.SEND_MESSAGE_URI}'));
    ...
    if (file != null && ResponsiveHelper.isMobilePhone()) {
      ...
      http.MultipartFile part = http.MultipartFile(
          'image', file.readAsBytes().asStream(), _list.length,
