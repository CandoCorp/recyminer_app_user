...
class RouteHelper {
  ...
  static String getCheckoutRoute(double amount, double discount, String type) => '$checkout?amount=$amount&discount=$discount&type=$type';
  ...
  static String getProductDescriptionRoute(String description, String id) => '$productDescription?id=$id&description=$description';
...
/*  static Handler _orderSuccessfulHandler = Handler(handlerFunc: (BuildContext context, Map<String, dynamic> params) {
  ...
  static Handler _productDescriptionHandler = Handler(handlerFunc: (BuildContext context, Map<String, dynamic> params) {
    ...
    return _descriptionScreen != null ? _descriptionScreen : DescriptionScreen(description: params['description'][0]);
  });
