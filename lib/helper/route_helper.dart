...
import 'package:recyminer_app/data/model/response/order_model.dart';
import 'package:recyminer_app/data/model/response/product_model.dart';
import 'package:recyminer_app/data/model/response/userinfo_model.dart';
import 'package:recyminer_app/helper/html_type.dart';
import 'package:recyminer_app/view/screens/address/add_new_address_screen.dart';
import 'package:recyminer_app/view/screens/address/address_screen.dart';
import 'package:recyminer_app/view/screens/address/select_location_screen.dart';
...
import 'package:recyminer_app/view/screens/auth/signup_screen.dart';
...
import 'package:recyminer_app/view/screens/checkout/checkout_screen.dart';
import 'package:recyminer_app/view/screens/checkout/order_successful_screen.dart';
import 'package:recyminer_app/view/screens/checkout/payment_screen.dart';
...
import 'package:recyminer_app/view/screens/forgot_password/forgot_password_screen.dart';
...
import 'package:recyminer_app/view/screens/notification/notification_screen.dart';
...
import 'package:recyminer_app/view/screens/order/order_details_screen.dart';
import 'package:recyminer_app/view/screens/order/track_order_screen.dart';
import 'package:recyminer_app/view/screens/product/category_product_screen.dart';
import 'package:recyminer_app/view/screens/product/daily_item_screen.dart';
import 'package:recyminer_app/view/screens/product/image_zoom_screen.dart';
import 'package:recyminer_app/view/screens/product/new_product_screen.dart';
import 'package:recyminer_app/view/screens/product/product_description_screen.dart';
import 'package:recyminer_app/view/screens/product/product_details_screen.dart';
import 'package:recyminer_app/view/screens/profile/profile_edit_screen.dart';
import 'package:recyminer_app/view/screens/profile/profile_screen.dart';
import 'package:recyminer_app/view/screens/search/search_result_screen.dart';
import 'package:recyminer_app/view/screens/search/search_screen.dart';
import 'package:recyminer_app/view/screens/settings/setting_screen.dart';
import 'package:recyminer_app/view/screens/splash/splash_screen.dart';
...
class RouteHelper {
  ...
  static String productCreation = '/product-creation';
  ...
  static String getCheckoutRoute(double amount, double discount, String type) =>
      '$checkout?amount=$amount&discount=$discount&type=$type';
  ...
  static String createProduct(String idCategory, String idSubCategory) =>
      '$productCreation?idCategory=$idCategory?idSubcategory=$idSubCategory';
  static String getProductDescriptionRoute(String description, String id) =>
      '$productDescription?id=$id&description=$description';
  ...
  static String getProfileEditRoute(
      ...
      '$profileEdit?fname=$fname&lname=$lname&email=$email&phone=$phone';
...
/*  static Handler _orderSuccessfulHandler = Handler(handlerFunc: (BuildContext context, Map<String, dynamic> params) {
  ...
  static Handler _productDescriptionHandler =
    ...
    return _descriptionScreen != null
        ? _descriptionScreen
        : DescriptionScreen(description: params['description'][0]);
  });

//  static Handler _productCreationHandler = Handler(handlerFunc: (BuildContext context, Map<String, dynamic> params) {
//    //DescriptionScreen _descriptionScreen = ModalRoute.of(context).settings.arguments;
//    AddNewAddressScreen _newProductScreen = ModalRoute.of(context).settings.arguments;
//    return _newProductScreen != null ? _newProductScreen : AddNewAddressScreen();
//  });

  static Handler _productCreationHandler =
      Handler(handlerFunc: (BuildContext context, Map<String, dynamic> params) {
    AddNewProductScreen _addNewProductScreen =
        ModalRoute.of(context).settings.arguments;
    return _addNewProductScreen != null
        ? _addNewProductScreen
        : AddNewProductScreen(
            isEnableUpdate: false,
            //idCategory: int.parse(params['idCategory'][0]),
            //idSubCategory: int.parse(params['idSubCategory'][0]),
          );
  });
  ...
  static Handler _searchResultHandler =
      Handler(handlerFunc: (BuildContext context, Map<String, dynamic> params) {
    return SearchResultScreen(searchString: params['text'][0]);
  });
...
//  static Handler _takePictureHandler =
//      Handler(handlerFunc: (BuildContext context, Map<String, dynamic> params) {
...
//  });
  ...
  static Handler _takePictureHandler =
    ...
    TakePictureScreen _takePictureScreen =
        ModalRoute.of(context).settings.arguments;
    return _takePictureScreen != null
        ? _takePictureScreen
        : TakePictureScreen();
  });

  //static Handler _takePictureHandler = Handler(handlerFunc: (BuildContext context, Map<String, dynamic> params) => TakePictureScreen(camera: camera));
  ...
  static void setupRouter() {
    ...
    router.define(productDescription,
        ...
        transitionType: TransitionType.fadeIn);
    router.define(productCreation,
        handler: _productCreationHandler,
        transitionType: TransitionType.fadeIn);
    ...
    router.define(takePicture,
        handler: _takePictureHandler, transitionType: TransitionType.fadeIn);
