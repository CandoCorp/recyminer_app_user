...
import 'package:recyminer_app/view/screens/chat/widget/message_bubble.dart';
import 'package:recyminer_app/view/screens/chat/widget/message_bubble_shimmer.dart';
                                    ...
                                    child: Stack(
                                      ...
                                      children: [
                                        ResponsiveHelper.isMobilePhone()
                                            ? Image.file(File(chat.file.path),
                                                height: 70,
                                                width: 70,
                                                fit: BoxFit.cover)
                                            : Image.network(chat.file.path,
                                                height: 70,
                                                width: 70,
                                                fit: BoxFit.cover),
                                        Positioned(
                                          ...
                                          child: InkWell(
                                            onTap: () => chat
                                                .removeImage(_controller.text),
                                            child: Icon(Icons.cancel,
                                                color: ColorResources
                                                    .getCardBgColor(context)),
                                          ),
                                        ),
                                      ],
                                    ),
