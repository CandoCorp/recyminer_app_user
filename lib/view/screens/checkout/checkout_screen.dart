...
import 'package:recyminer_app/data/model/body/place_order_body.dart';
...
import 'package:recyminer_app/view/screens/checkout/widget/custom_check_box.dart';
                                                                      ...
                                                                      children: [
                                                                        Container(
                                                                          ...
                                                                          decoration:
                                                                            ...
                                                                            boxShadow: [
                                                                              BoxShadow(color: Colors.grey.withOpacity(0.2), spreadRadius: .5, blurRadius: .5)
                                                                            ],
                                                                          ),
                                                                          child: Row(
                                                                                ...
                                                                                Padding(
                                                                                  ...
                                                                                  child: Container(
                                                                                    ...
                                                                                    decoration: BoxDecoration(
                                                                                      ...
                                                                                      border: Border.all(
                                                                                        color: index == order.addressIndex ? Theme.of(context).primaryColor : ColorResources.getHintColor(context).withOpacity(0.6),
                                                        ...
                                                        index == 0
                                                            ...
                                                            : index == 1
                                                                ? getTranslated(
                                                                    'tomorrow',
                                                                    context)
                                                                : DateConverter.estimatedDate(DateTime
                                                                        .now()
                                                                    .add(Duration(
                                                                        days:
                                                                            2))),
                                        ...
                                        onPressed: () {
                                          if (widget.orderType !=
                                            ...
                                            for (int index = 0;
                                                ...
                                                index++) {
                                              Cart cart = Cart(
                                                productId: _cartList[index].id,
                                                price: _cartList[index].price,
                                                discountAmount: _cartList[index]
                                                    .discountedPrice,
                                                quantity:
                                                    _cartList[index].quantity,
                                                taxAmount: _cartList[index].tax,
                                                variant: '',
                                                variation: [
                                                  Variation(
                                                      type: _cartList[index]
                                                                  .variation !=
                                                              null
                                                          ? _cartList[index]
                                                              .variation
  ...
  void _callback(bool isSuccess, String message, String orderID) async {
    if (isSuccess) {
      Provider.of<ProductProvider>(context, listen: false)
          .getPopularProductList(context, '1', true);
      ...
      if (_isCashOnDeliveryActive &&
        ...
        OrderModel _orderModel = OrderModel(
          ...
          userId: Provider.of<ProfileProvider>(context, listen: false)
              .userInfoModel
              .id,
          couponDiscountAmount: widget.discount,
          orderStatus: 'pending',
        ...
        if (ResponsiveHelper.isWeb()) {
          ...
          String selectedUrl =
              ...
              '&&callback=http://$hostname${RouteHelper.orderSuccessful}$orderID';
