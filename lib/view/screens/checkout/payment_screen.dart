...
import 'package:recyminer_app/view/screens/checkout/widget/cancel_dialog.dart';
            ...
            WebView(
              ...
              onPageStarted: (String url) {
                ...
                bool _isSuccess = url.contains('success') &&
                    url.contains(AppConstants.BASE_URL);
                bool _isFailed =
                ...
                if (_isSuccess) {
                  Navigator.pushReplacementNamed(context,
                      '${RouteHelper.orderSuccessful}${widget.orderModel.id}/payment-success');
                } else if (_isFailed) {
                  Navigator.pushReplacementNamed(context,
                      '${RouteHelper.orderSuccessful}${widget.orderModel.id}/payment-fail');
                } else if (_isCancel) {
                  Navigator.pushReplacementNamed(context,
                      '${RouteHelper.orderSuccessful}${widget.orderModel.id}/payment-cancel');
                }
              },
