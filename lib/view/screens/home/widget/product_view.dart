...
import 'package:recyminer_app/helper/product_type.dart';
...
import 'package:recyminer_app/view/base/product_shimmer.dart';
      ...
      if (scrollController.position.maxScrollExtent ==
        ...
        if (offset < pageSize) {
          ...
          Provider.of<ProductProvider>(context, listen: false)
              .showBottomLoader();
          Provider.of<ProductProvider>(context, listen: false)
              .getPopularProductList(context, offset.toString(), false);
        }
      }
    });
