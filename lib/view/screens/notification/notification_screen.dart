...
import 'package:recyminer_app/view/screens/notification/widget/notification_dialog.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: ResponsiveHelper.isDesktop(context)
          ? MainAppBar()
          : CustomAppBar(title: getTranslated('notification', context)),
      body: Center(
        child: Container(
          width: 1170,
                                                  ...
                                                  Row(
                                                    children: [
                                                      Column(
                                                        children: [
                                                          Text(
                                                            DateConverter.isoStringToLocalTimeWithAMPMOnly(
                                                                notificationProvider
                                                                    .notificationList[
                                                                        index]
                                                                    .createdAt),
                                                              ...
                                                              decoration: BoxDecoration(
                                                                  ...
                                                                  color: ColorResources
                                                                      .getGreyColor(
                                                                          context)),
                                                              child: Text(
                                                                DateConverter.isoStringToLocalAMPM(
                                                                    notificationProvider
                                                                        .notificationList[
                                                                            index]
                                                                        .createdAt),
