...
import 'package:recyminer_app/view/base/product_widget.dart';
  ...
  void _loadData(BuildContext context) async {
    if (flag == 0) {
      ...
      Provider.of<ProductProvider>(context, listen: false)
          .initCategoryProductList(categoryModel.id.toString(), context);
      Provider.of<ProductProvider>(context, listen: false)
              ...
              return Column(
                  ...
                  children: [
                    ResponsiveHelper.isDesktop(context)
                        ? SizedBox()
                        : CustomAppBar(
                            title: Provider.of<CategoryProvider>(context)
                                        .categoryModel !=
                                    null
                            ...
                            return InkWell(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    color: categoryProvider.filterIndex == index
                        ...
                        children: [
                          Expanded(
                            child: TextField(
                              ...
                              onChanged: Provider.of<ProductProvider>(context,
                                      listen: false)
                                  .searchProduct,
                              onSubmitted: Provider.of<ProductProvider>(context,
                                      listen: false)
                                  .searchProduct,
                            ...
                            child: productProvider.hasData
                                ? Padding(
                                    ...
                                    child: ProductShimmer(
                                        isEnabled: Provider.of<ProductProvider>(
                                                    context)
                                                .categoryProductList
                                                .length ==
                                            0),
